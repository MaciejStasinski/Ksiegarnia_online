...
insert into ksiazka(id, autor, cena, kategoria, opis, tytul, opis_Short, ksiazka_Foto) VALUES (4,
                                                                                               ...
                                                                                               '
                                                                                              Michelle Obama opisuje doświadczenia, które ją ukształtowały – od dzieciństwa w południowym Chicago, przez lata godzenia macierzyństwa z karierą, aż do czasu spędzonego w najsłynniejszym domu świata. Z niebywałą szczerością, odwagą i humorem odkrywa kulisy swojego życia rodzinnego. Opisuje, jak Obamowie znaleźli się w centrum zainteresowania światowych mediów i jak wyglądało ich życie w Białym Domu przez osiem kluczowych lat, kiedy poznawała Amerykę, a Ameryka poznawała ją. To zaskakująco intymny rozrachunek z życiem kobiety wrażliwej i stanowczej, która konsekwentnie odmawiała spełniania oczekiwań innych i której historia zachęca, by pójść w jej ślady.
                                                                                              ...
                                                                                              ',
                                                                                               ...
                                                                                               ','Michelle Obama opisuje doświadczenia, które ją ukształtowały – od dzieciństwa w południowym Chicago, przez lata godzenia macierzyństwa z karierą, aż do czasu spędzonego w najsłynniejszym domu świata. Z niebywałą szczerością, odwagą i humorem odkrywa kulisy swojego życia rodzinnego.', 'https://ecsmedia.pl/c/becoming-moja-historia-p-iext52620140.jpg');

insert into ksiazka(id, autor, cena, kategoria, opis, tytul, opis_Short, ksiazka_Foto) VALUES (5,
                                                                                               'Szczepański Dominik', 31.49,
                                                                                               'Biografie i autobiografie',
